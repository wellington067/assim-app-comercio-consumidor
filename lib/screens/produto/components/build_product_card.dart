...
import 'package:ecommerceassim/shared/core/controllers/produto_screen_controller.dart';
...
class _BuildProductCardState extends State<BuildProductCard> {
  ...
  Widget build(BuildContext context) {
    final ProdutoScreenController produtoScreenController = ProdutoScreenController();
    return FutureBuilder<List<TableProductsModel>>(
      future: produtoScreenController.loadList(),
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          return const Text('Erro ao carregar lista de produtos tabelados');
        } else if (snapshot.hasData) {
          print('mostrando produto${widget.produto.titulo}');
          List<TableProductsModel>? listaProdutosTabelados = snapshot.data;
          TableProductsModel? tableProductsModel = returnProdutoTabelado(widget.produto.produtoTabeladoId, listaProdutosTabelados);
            ...
            onTap: () {
              ...
              Navigator.pushNamed(
                ...
                arguments: {
                  ...
                  'produtoImage': tableProductsModel.imagem,
                  
                },
              );
              print('Produto ${widget.produto.titulo} foi tocado!');
            },
            child: Material(
              color: Colors.white,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                     Expanded(
                      child: Center(
                       child: tableProductsModel.imagem != null && base64Image != null
 ...
 TableProductsModel? returnProdutoTabelado(int id, List<TableProductsModel>? listaProdutos){
